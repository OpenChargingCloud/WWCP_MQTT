...
namespace cloud.charging.open.protocols.MQTT
{
    ...
    /// <summary>
    /// Receive charging stations downstream from an MQTT partner...
    /// </summary>
    public class MQTTCSOAdapter : //AWWCPEMPAdapter<ChargeDetailRecord>,
                                  IEMPRoamingProvider,
                                  ISendEnergyStatus,
                                  ...
                                  IComparable
    {
        ...
        public MQTTCSOAdapter(EMPRoamingProvider_Id                        Id,
                              I18NString                                   Name,
...

        {
            ...
            try
            {
                ...
                //        var location = ChargingPool.ToMQTT(out warnings);
...

        {
            ...
            try
            {
                ...
                if (lockTaken)
                {
                        ...
                        //            var evse2 = evse.ToMQTT(out var warning);
...

        {
            ...
            try
            {
                ...
                if (lockTaken)
                {
                    ...
                    //            var evse2 = EVSE.ToMQTT(out warnings);
...

        {
            ...
            try
            {
                ...
                if (lockTaken)
                {
                    ...
                    //                    var evse2 = evse.ToMQTT(ref warnings);
        ...
        /// </summary>
        /// <param name="MQTTCSOAdapter1">An MQTT CSO adapter.</param>
        ...
        /// </summary>
        /// <param name="Object">An MQTT CSO adapter to compare with.</param>
        public Int32 CompareTo(Object? Object)

            => Object is MQTTCSOAdapter evseDataRecord
                   ? CompareTo(evseDataRecord)
                   : throw new ArgumentException("The given object is not an MQTT CSO adapter!",
                                                 nameof(Object));
        ...
        /// Compares two MQTT CSO adapters.
        /// </summary>
        /// <param name="MQTTCSOAdapter">An MQTT CSO adapter to compare with.</param>
